...
const LoanModal = (props) => {
  ...
  const createLoan = async () => {
    ...
    let url = "http://192.168.1.190:5000/loan/" + currUserId + "/" + friendUserId
    if (!friendUserId){
      url = "http://192.168.1.190:5000/loan/" + currUserId + "/" + friendMobileNumber
    }
  ...
  return (
    <AppModal title="New Loan" onClose={props.onClose} onSubmit={createLoan} rightButton="OK">
      <View>
        <TouchableOpacity
          style={styles.row}
          onPress={() => {
        ...
        >
          ...
          <Ionicons
            name={userIsBorrower ? "md-radio-button-off" : "md-radio-button-on"}
            size={18}
          />
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          ...
          <Ionicons
            name={userIsBorrower ? "md-radio-button-on" : "md-radio-button-off"}
            size={18}
          />
        </TouchableOpacity>

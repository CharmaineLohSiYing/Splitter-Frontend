...
export const createBill = () => {
  return async (dispatch, getState) => {
    ...
    const response = await fetch("http://192.168.1.231:5000/api/bill", {
      method: "POST",
      headers: {
...
export const fetchUserBills = () => {
  ...
  return async (dispatch, getState) => {
    const response = await fetch(
      "http://192.168.1.231:5000/api/bill/user/" + getState().auth.userId,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const retrieveForEdit = (billId, matchedContacts) => {
  ...
  return async (dispatch, getState) => {
    const response = await fetch(
      "http://192.168.1.231:5000/api/bill/retrieveForEdit/" + billId,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
